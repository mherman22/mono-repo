# pams-backend
This is a backend service created using the [Parse Server](https://github.com/ParsePlatform/parse-server) module on Express.

note: https://blogfordevelopers.hashnode.dev/monorepo-convert-existing-multi-repo-projects-into-monorepo-using-lerna 
